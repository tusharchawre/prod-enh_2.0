...
import { document } from "postcss";
 ...
 export const Navigation =()=>{
  ...
  const params = useParams();
    ...
    className={cn(
        "group/sidebar h-full overflow-y-auto relative flex w-60 flex-col z-[9999] border-white border-1 glassblur",
      ...
      >
        ...
        <div>
            ...
            <Item onClick={handleCreate} label="New Note" isNewNote icon={PlusCircle} />
            
        </div>
        <div className="mt-4">
            <DocumentList userId={JSON.stringify(user?.id)} />
        </div>
        <Popover >
        ...
        className="opacity-0 group-hover/sidebar:opacity-50 transition cursor-ew-resize absolute h-full w-1 bg-neutral-400 right-0 top-0"></div>
    </aside>
    <div
    ref={navbarRef}
    className={cn(
