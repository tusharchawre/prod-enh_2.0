...
export const TrashBox = () =>{
    ...
    const documents = useQuery(api.documents.getTrash, {userId: JSON.stringify(useCurrentUser()?.id)});
        ...
        if (documents === undefined){
            return(
                <div className="h-full flex items-center justify-center p-4">
                    <RingLoader className="h-4 w-4" size={20} />
                </div>
            )
        }
    ...
    return(
        <div className="text-sm">
            <div className="flex items-center gap-x-1 p-2">
                <Search className="h-4 w-4" color="black"/>
                <Input
                value={search}
            ...
            <div className="mt-2 px-1 pb-1">
                <p className="hidden last:block text-black text-xs text-center">
                    No documents found.
                </p>
